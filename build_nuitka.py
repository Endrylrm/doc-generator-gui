    ...
    if currentOS == "Windows":
        subprocess.run(
            [
                ...
                "--windows-icon-from-ico=./assets/icons/gen_document.ico",
                "--include-data-dir=./documents=documents",
                "--include-data-dir=./data=data",
                "--include-data-files=./assets/icons/gen_document.png=assets/icons/gen_document.png",
    ...
    if currentOS == "Linux":
        subprocess.run(
            [
                ...
                "--enable-plugin=pyside6",
                "--playwright-include-browser=none",
                "--linux-icon=./assets/icons/gen_document.png",
                "--disable-console",
                "--include-data-dir=./documents=documents",
                "--include-data-dir=./data=data",
                "--include-data-files=./assets/icons/gen_document.png=assets/icons/gen_document.png",
    ...
    if currentOS == "Darwin":
        subprocess.run(
            [
                ...
                "--macos-app-icon=./assets/icons/gen_document.icns",
                "--include-data-dir=./documents=documents",
                "--include-data-dir=./data=data",
                "--include-data-files=./assets/icons/gen_document.png=assets/icons/gen_document.png",
                "--include-data-files=./.venv/lib/python3.13/site-packages/PySide6/Qt/translations/qt_*=PySide6/Qt/translations/",
